...
const { prefix, CLIENTID, mainGuild, mongoDB, join_leavelog } = require("./config.json");
...
setInterval(async () => {
  ...
  let suggestionprice = db3.get(`SuggestionP`) || `10000`;
  ...
  const taxprice = db3.get(`TaxP`) || `10000`;
  ...
  const bankprice = db3.get(`BankP`) || `10000`;
  ...
  const ticketprice = db3.get(`TicketP`) || `10000`;
  ...
  let systemprice = db3.get(`SystemP`) || `10000`;
  ...
  let brodcastprice = db3.get(`BrodcastP`) || `10000`;
  ...
  let giveawayprice = db3.get(`GiveawayP`) || `10000`;
  ...
  let scammerprice = db3.get(`ScammerP`) || `10000`;
  ...
  let probotprice = db3.get(`ProbotP`) || `10000`;
  ...
  let logprice = db3.get(`LogP`) || `10000`;
  ...
  let feedprice = db3.get(`FeedP`) || `10000`;
  ...
  let shopprice = db3.get(`ShopP`) || `10000`;
  ...
  await LiveMessage.edit({ embeds: [liveEmbed] });
}, 25000);
...
client.on('ready', () => {
  ...
  client.guilds.cache.forEach((guild) => {
    if (!subs.includes(guild.id) && guild.id !== '1180769607590625360' && guild.id !== '1180769607590625360') {
      if (guild) {
        guild.leave().catch(err => { })
      }
    }
...
client.on('ready', async () => {
  ...
  client.guilds.cache.forEach((guild) => {
    if (!data.includes(guild.id) && guild.id !== `1180769607590625360` && guild.id !== `1180769607590625360` && guild.id !== `1180769607590625360`) {
      guild.leave().catch(err => { })
